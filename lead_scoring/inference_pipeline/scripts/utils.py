...
from lead_scoring.inference_pipeline.scripts.constants import *
...
def get_models_prediction():
   ...
   # set the tracking uri
    ...
    # read the new data
    cnx = sqlite3.connect(DB_PATH+DB_FILE_NAME)
    query = 'select * from feature_inference'
    df_new_data = pd.read_sql(query,cnx)
